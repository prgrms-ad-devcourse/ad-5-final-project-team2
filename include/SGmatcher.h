...
/**
 * SGmatcher Class
 * 1. 무식하게 모든 기능을 Superglue로 처리 후 추후 속도 성능을 개선하는 방향으로 한다.
 * 
 */
...
namespace ORB_SLAM3
{
    ...
    private:
        static std::shared_ptr<SuperGlue> mSuperglue; //< Superglue model
